...
MemberJfgz mj=(MemberJfgz)request.getAttribute("waitEdit_doc");
if (mj==null)
{
%>
...
<td>
    ...
    <td valign="top" align='left'>
  	<s:form method="post" action="updateJfgz" name="form1" theme="simple" >
        ...
        <td align='left'>
            <INPUT class=form value="<%=mj.getJfs()%>" onchange='checkFs()' 
        ...
        <td align='left'>
            <INPUT class=form value="<%=mj.getJfDw()%>"  
			style="WIDTH: 50px" type="text" 
        ...
        <td align='left'>
            <textarea rows=5 cols=70 name="strContent" class=form><%=mj.getStrContent()%></textarea>        
        </td>
        </tr>
			<tr><td style='height:5px;' colspan=2 class='td_dash'>&nbsp;</td></tr>
	   		<tr><td style='height:10px;' colspan=2>&nbsp;</td></tr>
