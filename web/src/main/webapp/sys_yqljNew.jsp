...
<td>
    ...
    <td valign="top" align='left'>
  	<s:form method="post" action="saveYqlj" name="form1" theme="simple"  enctype="multipart/form-data">
	   	<input type='hidden' name='linkImg' value='' />
		<table cellspacing='0' cellpadding="0" border='0' width='95%'>
        <tr>
        <td align='right' width=20% >链接名称:&nbsp;<font color=red>*</font></td>
        <td align='left'>&nbsp;
            <INPUT class=form value=""
			style="WIDTH: 400px" type="text" maxLength=50
				name="ljName" minlength="6">        
        </td>
        </tr>
			<tr><td style='height:5px;' colspan=2 class='td_dash'>&nbsp;</td></tr>
	   		<tr><td style='height:10px;' colspan=2>&nbsp;</td></tr>
        <tr>
        <td align='right' width=20% >链接地址:&nbsp;<font color=red>*</font></td>
        <td align='left'>&nbsp;
            <INPUT class=form value=""
			style="WIDTH: 400px" type="text" maxLength=50
				name="ljAddr" minlength="6">        
        </tr>
			<tr><td style='height:5px;' colspan=2 class='td_dash'>&nbsp;</td></tr>
	   		<tr><td style='height:10px;' colspan=2>&nbsp;</td></tr>
		<tr>
