...
Tsjy tj=(Tsjy)request.getAttribute("waitEdit_doc");
if (tj==null)
{
%>
...
<tr>
<td align="left">
  	<s:form method="post" action="saveTsjyHf" name="form1" theme="simple" >
  	<input type=hidden name='tsjyId' value='<%=tj.getTsjyId()%>' />
        ...
        <td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;<%=tj.getFbUserName()%>
        </td>
        </tr>
			<tr><td style='height:5px;' colspan=2 class='td_dash'>&nbsp;</td></tr>
	   		<tr><td style='height:10px;' colspan=2>&nbsp;</td></tr>
        ...
        <td align='left'>&nbsp;&nbsp;&nbsp;&nbsp;<%=tj.getStrContent()%>
		</TD>
		</TR>
			<tr><td style='height:5px;' colspan=2 class='td_dash'>&nbsp;</td></tr>
	   		<tr><td style='height:10px;' colspan=2>&nbsp;</td></tr>
        <tr>
        <td align='right' style='font-color:#7F7F7F;'>回复内容:</td>
        <td align='left'>&nbsp;&nbsp;
			<textarea name='hfContent' cols=70 rows="15" style='overflow-y:auto;overflow-x:auto;'></textarea>
		</TD>
		</TR>
			<tr><td style='height:5px;' colspan=2 class='td_dash'>&nbsp;</td></tr>
	   		<tr><td style='height:10px;' colspan=2>&nbsp;</td></tr>
