...
<tr style='height:30px;'>
	<td style='background:url(<%=basePath%>/images/top_bottom.gif) no-repeat;'/>
        ...
        <td width=4%></td>
    	<td align="left">
    		您现在所在的位置: <a href='<%=basePath%>/manager.jsp'>首页</a> > <a href='<%=basePath%>/firstBA.action'>贝爱学园</a> > 我要分享
		</td>
    	</tr>
    	</table>
    </td>
...
<td align=center >
	...
	<td colspan=3 align='left'>&nbsp;&nbsp;<textarea name='strContent' cols=70 rows="4" style='overflow-y:auto;overflow-x:auto;'><s:property value='strContent' /></textarea></td>
    </tr>
	<TR><TD height=8 colspan=4 class=td_dash></TD></TR>
	<TR><TD height=8 colspan=4></TD></TR>
	<tr >
    ...
    <td align='left'>&nbsp;
    <INPUT class=form value="<s:property value='strLable' />"
			style="WIDTH: 200px" type="text" maxLength=32
