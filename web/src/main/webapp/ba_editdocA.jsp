...
if (!(strUserAcl.indexOf("999")>=0 | strUserAcl.indexOf("BA509")>=0))
{
%> 
	<jsp:forward page="login.jsp" />
<%
...
<tr style='height:30px;'>
	<td style='background:url(<%=basePath%>/images/top_bottom.gif) no-repeat;'/>
        ...
        <td width=4%></td>
    	<td align="left">
    		您现在所在的位置: <a href='<%=basePath%>'>首页</a> > <a href='<%=basePath%>/sysmanaBa.action'>系统管理</a> > 文章编辑
		</td>
    	</tr>
    	</table>
    </td>
...
<td style='height:40px;'>
	...
	<td align='center' width=20%>
		<font color='#1F9393' size='4'><b>文章编辑</b></font>
	</td>
    <td>&nbsp;</td>
	</tr>
	</table>
...
<tr>
<td align=center >
  	<s:form method="post" action="updateBaxyA" name="form1" theme="simple" >
