...
<td align='left'>
    ...
    <td valign='top'>
    <!-- 文档区 -->
  		<s:form method="post" action="updateHomeJs" name="form1" theme="simple" >
  		<input type='hidden' name='jsId' value='<%=hj.getJsId()%>'/>
  		<input type='hidden' name='strMemo' value='<%=hj.getStrMemo()%>'/>
    	<table border="0" cellspacing="0" cellpadding="0" width=100% >
   		<tr style='height:10px;' ><td colspan=2></td></tr>
		<tr>
		<td align='right' width=70 >主题<font color=red>*</font>：</td>
    	<td align='left'>&nbsp;
    	<INPUT class=form value="<%=hj.getJsTitle()%>" style="WIDTH: 400px" type="text" name="jsTitle" >
    	</td>
		</tr>
    	...
    	<td align='left'>&nbsp;
    	<INPUT class=form value="<%=hj.getStrContent()%>" style="WIDTH: 400px" type="text" name="strContent" >
    	</td>
		</tr>
		<TR><TD height=8 colspan=2 class=td_dash></TD></TR>
		<TR><TD height=8 colspan=2></TD></TR>
    	...
    	<td align='left'>&nbsp;
		<textarea name="strMemo_p" cols="100" rows="8" style="width:600px;height:200px;visibility:hidden;"><%=hj.getStrMemo()%></textarea>
    	</td>
		</tr>
		<TR><TD height=8 colspan=2 class=td_dash></TD></TR>
		<TR><TD height=8 colspan=2></TD></TR>
